<template>
  <v-expand-transition>
    <v-alert
      v-if="error" text dense
      :prominent="critical" type="error" :icon="alert_icon"
    >
      <v-row align="center">
        ...
        <v-col class="shrink" :class="critical || 'py-0'" @click="action">
          <v-btn v-if="!critical && action_text" outlined color="error">
            {{ action_text }}
          </v-btn>
